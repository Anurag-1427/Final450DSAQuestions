// We have already discussed a O(n2) solution that maintains the order of appearance in the array in index.cpp. If we are allowed to change order of appearance, we can solve this problem in O(n) time and O(1) space.
...
// Function to rearrange positive and negative integers in alternate fashion. The below
