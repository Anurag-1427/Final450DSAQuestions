// Kindly find the time and space complexity on your own. By the way, it is already an efficient solution
...
// An efficient method to find maximum value of mat[c][d] - ma[a][b] such that c > a and d > b
#include <bits/stdc++.h>
using namespace std;
#define N 5
